...
- Game Day dark live-side board with a thin TeamBar, compact live warning strip, Now Batting hero, On Deck area, control row, 3-across fallback grid, and obvious active tap-to-stop state
