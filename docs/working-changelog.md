...
- Game Day and Clips can now be switched with a deliberate horizontal swipe, with a small visual nudge while swiping and playback continuing uninterrupted whether coaches use the swipe or the tab bar. [public candidate] [needs review]
