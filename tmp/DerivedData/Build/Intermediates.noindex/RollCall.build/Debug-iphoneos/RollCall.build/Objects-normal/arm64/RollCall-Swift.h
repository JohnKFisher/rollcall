...
#ifndef ROLLCALL_SWIFT_H
#define ROLLCALL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RollCall",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8RollCall17CuePlaybackEngine")
@interface CuePlaybackEngine : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class AVAudioRecorder;
SWIFT_CLASS("_TtC8RollCall23CustomAnnouncerRecorder")
@interface CustomAnnouncerRecorder : NSObject <AVAudioRecorderDelegate>
